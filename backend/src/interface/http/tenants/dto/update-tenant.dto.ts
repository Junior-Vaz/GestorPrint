...
export class UpdateTenantDto {
  ...
  @ValidateIf(o => !!o.trialEndsAt) @IsOptional() @IsISO8601() trialEndsAt?: string;
  @ValidateIf(o => !!o.planExpiresAt) @IsOptional() @IsISO8601() planExpiresAt?: string;
  ...
  @ValidateIf(o => !!o.cpfCnpj) @IsOptional() @Matches(/^\d{11}$|^\d{14}$/, { message: 'cpfCnpj deve ter 11 dígitos (CPF) ou 14 dígitos (CNPJ), apenas números' }) cpfCnpj?: string;
