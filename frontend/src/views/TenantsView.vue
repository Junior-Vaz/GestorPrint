<template>
  <div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-slate-800">Gestão SaaS</h1>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        ...
        <p class="text-2xl font-bold text-slate-800 mt-1">{{ dashboard?.totalTenants ?? '—' }}</p>
      </div>
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        <p class="text-xs text-slate-500 font-medium">Ativos + Trial</p>
        <p class="text-2xl font-bold text-emerald-600 mt-1">{{ kpiActive }}</p>
      </div>
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        <p class="text-xs text-slate-500 font-medium">Suspensos</p>
        <p class="text-2xl font-bold text-red-500 mt-1">{{ statusCounts.SUSPENDED }}</p>
      </div>
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        <p class="text-xs text-slate-500 font-medium">PRO + Enterprise</p>
        <p class="text-2xl font-bold text-indigo-600 mt-1">{{ kpiProPlus }}</p>
      </div>
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        <p class="text-xs text-slate-500 font-medium">MRR Estimado</p>
        <p class="text-2xl font-bold text-slate-800 mt-1">R${{ dashboard?.mrr ?? 0 }}</p>
      </div>
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
